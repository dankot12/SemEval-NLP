...
train = pd.read_csv("CSV Files/Train_data_no_direction.csv", header=0, delimiter=",")
...
# bag of words tool.
vectorizer = CountVectorizer(analyzer = "word",tokenizer = None,preprocessor = None,stop_words = None,max_features =24000,ngram_range=(1,4))
...
keys = pd.read_csv("CSV Files/Test_Keys_no_direction.csv", header=0, delimiter="\t")
